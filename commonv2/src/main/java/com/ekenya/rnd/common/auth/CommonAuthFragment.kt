...
class CommonAuthFragment : BaseDaggerFragment() {
...
//                textViewVoiceId.setBiometricsLauncher()
    ...
    private fun simulateLoading(authResult: AuthResult) {
        lifecycleScope.launch {
            simulateSearching()
            // Use the Kotlin extension in the fragment-ktx artifact
            setFragmentResult("requestKey", bundleOf(AuthResultTag to authResult))
