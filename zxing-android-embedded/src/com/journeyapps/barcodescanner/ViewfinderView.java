...
//        paint.setColor(resultBitmap != null ? resultColor : maskColor);
        canvas.drawCircle(width /2 , height/2, 250, rectPaint);
        ...
        if (resultBitmap != null) {
            ...
            if (laserVisibility) {
                ...
                final int middleHeight = frame.height() / 2 + frame.top;
                final int middleWidth = frame.width() / 2 + frame.left;
                ...
                canvas.drawRect(left, middleHeight - 1, right, middleHeight + 2, paint);
            }
